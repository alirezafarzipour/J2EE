...
<div class="container">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading"><h2 style="margin-top: 20px">YOUR PROCESS</h2></div>
        <div class="panel-body">
            <table class="table table-hover" style="width: 100%">
                ...
                <c:forEach items="${requestScope.processListByRole}" var="process">
                    <tr>
                        <form action="/adminAct/sendSignal.do">
